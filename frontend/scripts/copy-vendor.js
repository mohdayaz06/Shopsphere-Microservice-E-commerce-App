 ...
 * copy-vendor.js
 *
 * After `npm install`, copies the compiled library files needed at
 * runtime (AngularJS core + modules, Bootstrap CSS/JS, Bootstrap Icons)
 * out of node_modules and into src/vendor/. This keeps the app fully
 * self-contained - useful when the frontend is packaged into a Docker
 * image and served by Nginx with no internet access and no CDN dependency.
 */
const fs = require('fs');
